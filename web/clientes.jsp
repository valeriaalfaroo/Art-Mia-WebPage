<%-- 
    Document   : Clientes
    Created on : 21 feb. 2023, 21:39:29
    Author     : laboratorio
--%>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    ...
                    <form class="comment-form mb-5 gray-bg p-5" name="clientes" action="" method="POST">
                        <h3 class="mb-4 text-center">Ingrese un cliente</h3>
...
try{
    ...
    fichero = new FileWriter("//Users//valeriaalfaro//Desktop//proyectoValeriaAlfaro//clientes.txt",true);
