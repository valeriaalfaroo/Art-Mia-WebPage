<%-- 
    Document   : eliminarFacturas
    Created on : Apr 17, 2023, 5:55:45 PM
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    ...
                    <form class="comment-form mb-5 gray-bg p-5" name="eliminarFacturas" action="" method="POST">
                        <h3 class="mb-4 text-center">Elimine la información de todas las facturas</h3>
                    
                        <input type="radio" name="condiciones" value="aceptada" required/> Acepto que al darle click al botón se eliminará toda la información almacenada de la sección de Facturas 
