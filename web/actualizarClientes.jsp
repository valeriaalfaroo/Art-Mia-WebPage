<%-- 
    ...
    Created on : Apr 7, 2023, 9:58:48 PM
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    ...
                    <form class="comment-form mb-5 gray-bg p-5" name="actualizarClientes" action="" method="POST">
                        <h3 class="mb-4 text-center">Actualice un cliente</h3>
                    
                        <script type="text/javascript">
                            function mostrarTipo(){
               document.getElementById('secTarjeta').style.display='block';
               
            }
            function ocultarTipo(){
               document.getElementById('secTarjeta').style.display='none';
                        ...
                        Cedula del Cliente:
                        <input type="number" name="cedulaCliente" value="" required /> <br><br>
                        Nombre del Cliente:
                        <input type="text" value="" name="nombreCliente" required /><br><br>
                        Tipo de Cliente: <br>
                        Nuevo<input type="radio" value="nuevo" name="opcionCliente" required /><br>
                        Regular<input type="radio" value="regular" name="opcionCliente" required /><br>
                        Metodo de pago: <br>
                        Efectivo<input type="radio" value="efectivo" name="metodoPago" required onclick="ocultarTipo()"/><br>
                        Tarjeta<input type="radio" value="tarjeta" name="metodoPago" required onclick="mostrarTipo()" /><br>
                        <div id="secTarjeta" style="display: none">
                        Tipo de tarjeta: <br>
                        Debito<input type="radio" value="debito" name="tipoTarjeta" /><br>
                        Credito<input type="radio" value="credito" name="tipoTarjeta" /><br>
                        Numero de tarjeta:
                        <input type="number" name="numeroTarjeta" value="" /> <br><br>
                        </div>
...
================================================== -->
    ...
    String tipo= request.getParameter("opcionCliente"); 
    String metodoPago=request.getParameter("metodoPago");
    String tipoTarjeta=request.getParameter("tipoTarjeta");
    String numeroTarjeta=request.getParameter("numeroTarjeta");
    
    
 if(cedula!= null && nombre!=null && tipo!=null && metodoPago!=null){
 try{
    fichero = new FileWriter("//Users//valeriaalfaro//Desktop//proyectoValeriaAlfaro//clientes.txt");
    pw = new PrintWriter(fichero);
    pw.println(" ****"); 
    pw.println(" Cliente: "); 
    pw.println(" Cedula: "+cedula); 
    pw.println(" Nombre: "+nombre); 
    pw.println(" Tipo de Cliente: "+tipo); 
    pw.println(" Metodo de Pago: "+metodoPago); 
    if(metodoPago.equals("tarjeta")){
    pw.println(" Tipo de Tarjeta: "+tipoTarjeta); 
    pw.println(" Número de Tarjeta:  "+numeroTarjeta); 
     }
