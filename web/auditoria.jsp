<%-- 
    Document   : acercaDe
    Created on : Mar 24, 2023, 12:06:23 PM
...
<body>
    ...
    <section class="single-block-wrapper section-padding">
       ...
       try{
        archivo = new File ("//Users//valeriaalfaro//Desktop//proyectoValeriaAlfaro//loginUsuarios.txt");
        fr = new FileReader (archivo);
        br = new BufferedReader(fr);
        String datos=" "; 
        out.print("<h2> Login de usuarios </h2>");
        while(br.read()>0){
       ...
       try{
        archivo = new File ("//Users//valeriaalfaro//Desktop//proyectoValeriaAlfaro//salidaUsuarios.txt");
        fr = new FileReader (archivo);
        br = new BufferedReader(fr);
        String datos=" ";
        out.print("<h2> Salidas de usuarios </h2>");
        while(br.read()>0){
            datos += br.readLine().toString(); 
            datos+=" <br> "; 
            }
