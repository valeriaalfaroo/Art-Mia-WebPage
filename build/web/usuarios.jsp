<%-- 
    Document   : Usuarios
    Created on : 21 feb. 2023, 22:05:45
    Author     : laboratorio
--%>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    ...
                    <form class="comment-form mb-5 gray-bg p-5" name="usuarios" action="" method="POST">
           ...
           document.getElementById('secSalario').style.display='block'; 
                        ...
                        <h3 class="mb-4 text-center">Ingrese un usuario</h3>
                        Cédula:
...
================================================== -->
   ...
   <%
        ...
        try{
            ...
            fichero = new FileWriter("//Users//valeriaalfaro//Desktop//proyectoValeriaAlfaro//perfilUsuarios.txt",true);
