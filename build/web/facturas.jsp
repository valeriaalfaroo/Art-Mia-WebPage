<%-- 
    Document   : facturas
    Created on : 21 feb. 2023, 21:48:37
    Author     : laboratorio
--%>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    ...
                    <form class="comment-form mb-5 gray-bg p-5" name="facturas" action="" method="POST">
                        <script>
                            function date(){
                        ...
                        <h3 class="mb-4 text-center">Ingrese una factura</h3> 
     ...
     <%
         ...
         try{
           java.text.DateFormat df = new java.text.SimpleDateFormat("dd/MM/yyyy"); 
            ...
            fichero = new FileWriter("//Users//valeriaalfaro//Desktop//proyectoValeriaAlfaro//facturas.txt",true);
